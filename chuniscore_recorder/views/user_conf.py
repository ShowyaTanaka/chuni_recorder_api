...
from chuniscore_recorder.serializers import CreateUserSerializer, UpdateChuniUserSerializer
...
class UserConfigModifyViewSet(viewsets.GenericViewSet, viewsets.mixins.UpdateModelMixin):
